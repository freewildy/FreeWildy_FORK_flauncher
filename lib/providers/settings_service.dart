...
const _showUsageUptimeKey = "show_usage_uptime";
const _showUsageTodayKey = "show_usage_today";
const _showUsageWeekKey = "show_usage_week";
const _showUsageMonthKey = "show_usage_month";
...
class SettingsService extends ChangeNotifier {
  ...
  bool get showUsageUptime => _sharedPreferences.getBool(_showUsageUptimeKey) ?? true;
  bool get showUsageToday => _sharedPreferences.getBool(_showUsageTodayKey) ?? true;
  bool get showUsageWeek => _sharedPreferences.getBool(_showUsageWeekKey) ?? true;
  bool get showUsageMonth => _sharedPreferences.getBool(_showUsageMonthKey) ?? true;
  ...
  Future<void> setShowUsageUptime(bool value) => _setUsageFlag(_showUsageUptimeKey, value);
  Future<void> setShowUsageToday(bool value) => _setUsageFlag(_showUsageTodayKey, value);
  Future<void> setShowUsageWeek(bool value) => _setUsageFlag(_showUsageWeekKey, value);
  Future<void> setShowUsageMonth(bool value) => _setUsageFlag(_showUsageMonthKey, value);

  Future<void> _setUsageFlag(String key, bool value) async {
