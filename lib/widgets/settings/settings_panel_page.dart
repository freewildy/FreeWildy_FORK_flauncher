...
import 'package:flauncher/widgets/settings/apk_installer_panel_page.dart';
...
class SettingsPanelPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Consumer<SettingsService>(
        builder: (context, settingsService, __) => ListView(
          ...
          children: [
            Text("Paramètres", style: Theme.of(context).textTheme.headline6),
            Divider(),
            TextButton(
              child: Row(
                children: [
            ...
            TextButton(
              child: Row(
                children: [
                  ...
                  Container(width: 8),
                  Text("Installer un APK", style: Theme.of(context).textTheme.bodyText2),
                ],
              ),
              onPressed: () => Navigator.of(context).pushNamed(ApkInstallerPanelPage.routeName),
            ),
            TextButton(
              child: Row(
                children: [
                  ...
                  Container(width: 8),
                  Text("Historique d’utilisation", style: Theme.of(context).textTheme.bodyText2),
                ],
              ),
              onPressed: () => Navigator.of(context).pushNamed(UsageHistoryPanelPage.routeName),
            ),
            TextButton(
              child: Row(
                children: [
                  Icon(Icons.category),
                  Container(width: 8),
                  Text("Catégories", style: Theme.of(context).textTheme.bodyText2),
                ],
              ),
            ...
            TextButton(
              child: Row(
                children: [
                  ...
                  Container(width: 8),
                  Text("Fond d’écran", style: Theme.of(context).textTheme.bodyText2),
                ],
              ),
            ...
            TextButton(
              child: Row(
                children: [
                  ...
                  Container(width: 8),
                  Text("Paramètres Android", style: Theme.of(context).textTheme.bodyText2),
                ],
              ),
            ...
            SwitchListTile(
              ...
              title: Text("Utiliser le format 24 heures"),
              dense: true,
            ),
            Divider(),
            Text("Tuile Temps d’utilisation", style: Theme.of(context).textTheme.bodyText2),
            SwitchListTile(
              contentPadding: EdgeInsets.symmetric(horizontal: 8),
              value: settingsService.showUsageUptime,
              onChanged: settingsService.setShowUsageUptime,
              title: Text("Depuis le démarrage"),
              dense: true,
            ),
            SwitchListTile(
              contentPadding: EdgeInsets.symmetric(horizontal: 8),
              value: settingsService.showUsageToday,
              onChanged: settingsService.setShowUsageToday,
              title: Text("Aujourd’hui"),
              dense: true,
            ),
            SwitchListTile(
              contentPadding: EdgeInsets.symmetric(horizontal: 8),
              value: settingsService.showUsageWeek,
              onChanged: settingsService.setShowUsageWeek,
              title: Text("Semaine"),
              dense: true,
            ),
            SwitchListTile(
              contentPadding: EdgeInsets.symmetric(horizontal: 8),
              value: settingsService.showUsageMonth,
              onChanged: settingsService.setShowUsageMonth,
              title: Text("Mois"),
              dense: true,
            ),
            Divider(),
