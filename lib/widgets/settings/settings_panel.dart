            ...
            child: Navigator(
              ...
              onGenerateRoute: (settings) {
                switch (settings.name) {
                  ...
                  case ApkInstallerPanelPage.routeName:
                    return MaterialPageRoute(builder: (_) => ApkInstallerPanelPage());
                  case UsageHistoryPanelPage.routeName:
                    return MaterialPageRoute(builder: (_) => UsageHistoryPanelPage());
