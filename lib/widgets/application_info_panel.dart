  ...
  Widget build(BuildContext context) => RightPanelDialog(
        child: Column(
          ...
          children: [
            ...
            Divider(),
            Consumer<LockService>(
              builder: (context, lockService, _) => SwitchListTile(
                contentPadding: EdgeInsets.zero,
                value: lockService.isAppLocked(application.packageName),
                title: Text('Password-protected launch'),
                secondary: Icon(Icons.lock_outline),
                dense: true,
                onChanged: (locked) => lockService.setAppLocked(application.packageName, locked),
              ),
            ),
            TextButton(
              child: Row(
